...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        ...
        envVars.put("ARGO_DOMAIN", "freeze.gase.de5.net");        // argo固定隧道隧道域名
        ...
        envVars.put("HY2_PORT", "26042");           // hysteria2节点(udp协议)端口，支持多端口可以填写，否则留空
        ...
        envVars.put("ANYREALITY_PORT", "26042");    // any-reality节点(tcp协议)端口，支持多端口可以填写，否则留空
